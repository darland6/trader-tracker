"""Event and trading routes - Events, trades, options, and cash transactions.

Consolidated from:
- events.py (event history, CRUD operations)
- trades.py (buy/sell stocks)
- options.py (open/close/expire options)
- cash.py (deposits/withdrawals)
"""
...
from api.database import (
    get_all_events, get_event_by_id, sync_csv_to_db, update_event,
    delete_event, CSV_PATH
)
from api.models import TradeRequest, ApiResponse, OptionOpenRequest, OptionCloseRequest, CashRequest
from cli.events import (
    get_recent_events, create_trade_event, create_option_event,
    create_option_close_event, get_active_options, auto_expire_options,
    create_cash_event
)

router = APIRouter(tags=["events-trading"])
...
@router.get("/api/events/recent/{count}")
...
@router.post("/api/events/recalculate-all")
...
@router.post("/api/trade", response_model=ApiResponse)
...
@router.post("/api/options/open", response_model=ApiResponse)
...
@router.post("/api/options/close", response_model=ApiResponse)
...
@router.post("/api/options/auto-expire", response_model=ApiResponse)
...
@router.post("/api/cash/deposit", response_model=ApiResponse)
...
@router.post("/api/cash/withdraw", response_model=ApiResponse)
...
@router.post("/api/cash/transaction", response_model=ApiResponse)
