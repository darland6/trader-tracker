"""Portfolio routes - State and price management.

Consolidated from:
- state.py (portfolio state, holdings, income breakdown)
- prices.py (price updates, market hours)
"""
...
from api.database import get_cached_prices, update_price_cache, sync_csv_to_db, compact_price_events
